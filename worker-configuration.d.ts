/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f1511fa9628d94491cbeb92442a81a7f)
...
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		PHOLIO_API_BASE_URL: "http://host.docker.internal:3000";
		DATABASE_URL: string;
	...
	interface Env {
		MARKET_CACHE: KVNamespace;
		STORAGE_BUCKET: R2Bucket;
		PHOLIO_API_BASE_URL: "http://host.docker.internal:3000" | "https://pholio.markets";
		DATABASE_URL: string;
		FINNHUB_API_KEY: string;
		FMP_API_KEY: string;
		VERCEL_AI_GATEWAY_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PHOLIO_API_BASE_URL" | "DATABASE_URL" | "FINNHUB_API_KEY" | "FMP_API_KEY" | "VERCEL_AI_GATEWAY_KEY" | "CLERK_SECRET_KEY" | "CLERK_WEBHOOK_SECRET" | "CF_DEV_TUNNEL_TOKEN" | "API_TOKEN_SECRET">> {}
}
