/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f43f61a185346ec7f7f54a1916407da5)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ChatAgent" | "AnalysisSandbox";
	}
	interface DevEnv {
		MARKET_CACHE: KVNamespace;
		STORAGE_BUCKET: R2Bucket;
		TRADEME_API_BASE_URL: "http://host.docker.internal:3000";
		DATABASE_URL: string;
		...
		CF_DEV_TUNNEL_TOKEN: string;
		API_TOKEN_SECRET: string;
		CHAT: DurableObjectNamespace<import("./src/server/worker").ChatAgent>;
		ANALYSIS_SANDBOX: DurableObjectNamespace<import("./src/server/worker").AnalysisSandbox>;
	}
	interface Env {
		MARKET_CACHE: KVNamespace;
		STORAGE_BUCKET: R2Bucket;
		TRADEME_API_BASE_URL: "http://host.docker.internal:3000" | "https://trademe.sabaiscale.com";
		DATABASE_URL: string;
		FINNHUB_API_KEY: string;
		FMP_API_KEY: string;
		VERCEL_AI_GATEWAY_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TRADEME_API_BASE_URL" | "DATABASE_URL" | "FINNHUB_API_KEY" | "FMP_API_KEY" | "VERCEL_AI_GATEWAY_KEY" | "CLERK_SECRET_KEY" | "CLERK_WEBHOOK_SECRET" | "CF_DEV_TUNNEL_TOKEN" | "API_TOKEN_SECRET">> {}
}
